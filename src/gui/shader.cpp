...
// Project
#include "opengl4-tutorials-mbsoftworks/common_classes/stringUtils.h"
#include "shader.h"
...
bool Shader::loadShader(const std::string& shader, GLenum shaderType)
{
    const char * shader_string = shader.c_str();
    // Create and compile shader
    shaderID_ = glCreateShader(shaderType);
    glShaderSource(shaderID_, 1, &shader_string, nullptr);
    ...
    {
        std::cerr << "Error! Shader wasn't compiled!";
